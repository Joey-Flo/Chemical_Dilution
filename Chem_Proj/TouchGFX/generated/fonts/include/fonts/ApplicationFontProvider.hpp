...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId DISPLAY = 3;  // verdana_15_4bpp
    static const touchgfx::FontId MODE = 3;     // verdana_15_4bpp
    static const touchgfx::FontId KEYBOARD = 3; // verdana_15_4bpp

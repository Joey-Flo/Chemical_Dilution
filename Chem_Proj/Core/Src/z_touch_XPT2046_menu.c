...
#include "main.h" // Already there
#include "fonts.h"           // <--- ADD THIS (for sFONT, Font24)
#include "z_displ_ILI9XXX.h" // <--- ADD THIS (for Displ_ functions, colors)
#include "z_touch_XPT2046.h" // <--- ADD THIS (for Touch_ functions)
#include "z_touch_XPT2046_menu.h" // <--- ADD THIS (for Touch_ functions)

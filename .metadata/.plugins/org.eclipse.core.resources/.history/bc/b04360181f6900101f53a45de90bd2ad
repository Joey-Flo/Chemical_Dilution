...
#define TOUCH_SPI_PORT  hspi1 // This should be the same SPI handle as the display
#define TOUCH_SPI       SPI1  // This should be the same SPI instance as the display
